    ...
    $.ajax({
        ...
        success: function (data, status, jqXHR) {
            if (current_que == 'main') {
                ...
                $('#nowPlaying').append($('[name="now_playing"]', data).text());
		...
		current_nowplaying = $('[name="now_playing"]', data).text();

                if (previous_title != current_title) {
                    updatePlayList();
                }

		if ((previous_title != current_title) || (previous_nowplaying != current_nowplaying)) {
                    var pageTitle = "";
                    if (current_nowplaying != null) {
                        pageTitle += current_nowplaying + " - ";
                    }
                    if (current_title != null) {
                        pageTitle += current_title + " - ";
                    }
		    pageTitle += "VLC media player - Web Interface";
                    document.title = pageTitle;
		}

                previous_title = current_title;
		previous_nowplaying = current_nowplaying;
